...
I have experience with Python, JavaScript/TypeScript, and Java/C#, and I'm comfortable across the full stack — frontend, backend, and the glue in between, including both SQL (Postgres/MySQL/SQL Server) and NoSQL (MongoDB/DynamoDB) databases, AWS cloud infrastructure, and CI/CD pipelines. For this course I want to get better at the open-source contribution workflow itself (reading unfamiliar codebases, working through issue-to-PR the right way) and at using AI-assisted engineering effectively on real work. I'd like to avoid issues that require a language I don't already know, that need deep spelunking through a large, legacy codebase to even understand the fix, or that live in repos that look inactive or unresponsive.
